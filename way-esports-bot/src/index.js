...
const API_BASE_URL = String(process.env.API_BASE_URL || 'https://wayesports.org').replace(/\/+$/, '');
const WEBAPP_URL = String(process.env.WEBAPP_URL || 'https://wayesports.org').replace(/\/+$/, '');
