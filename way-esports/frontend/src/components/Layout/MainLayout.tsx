...
const Header = styled.header`
  ...
  padding: 1rem;
  background: linear-gradient(135deg, #1a1a1a 0%, #2a2a2a 25%, #808080 50%, #c0c0c0 75%, #1a1a1a 100%);
  color: #ffffff;
  box-shadow: 0 4px 20px rgba(128, 128, 128, 0.3), 0 0 40px rgba(192, 192, 192, 0.2);
  position: relative;
  ...
  &::before {
    ...
    right: 0;
    bottom: 0;
    background: linear-gradient(135deg, #808080, #c0c0c0, #a0a0a0, #808080);
...
const NavButton = styled.button<{ $active?: boolean }>`
  background: ${({ $active }) => $active 
    ? 'linear-gradient(135deg, rgba(128, 128, 128, 0.3), rgba(192, 192, 192, 0.2))' 
    : 'transparent'
  };
  ...
  border-radius: 8px;
  color: ${({ $active }) => $active ? '#c0c0c0' : '#ffffff'};
  padding: 0.8rem 0.5rem;
  display: flex;
  flex-direction: column;
  align-items: center;
  ...
  &:hover {
    ...
    background: linear-gradient(135deg, rgba(128, 128, 128, 0.2), rgba(192, 192, 192, 0.1));
