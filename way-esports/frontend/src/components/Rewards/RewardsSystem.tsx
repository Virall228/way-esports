...
const Tab = styled.button<{ $active: boolean }>`
  background: ${({ $active }) => 
    $active ? 'linear-gradient(135deg, #666666, #888888)' : 'rgba(42, 42, 42, 0.8)'};
  color: ${({ $active }) => $active ? '#ffffff' : '#cccccc'};
  border: 1px solid ${({ $active }) => $active ? '#888888' : 'rgba(128, 128, 128, 0.3)'};
  padding: 12px 24px;
  border-radius: 8px;
  font-weight: 600;
  cursor: pointer;
  ...
  &:hover {
    background: ${({ $active }) => 
      $active ? 'linear-gradient(135deg, #777777, #999999)' : 'rgba(128, 128, 128, 0.1)'};
...
const RewardCard = styled.div<{ $rarity: string; $unlocked?: boolean }>`
  ...
  border: 2px solid ${({ $rarity, $unlocked }) => 
    $unlocked ? 
      ($rarity === 'legendary' ? 'rgba(255, 255, 255, 0.6)' :
       $rarity === 'epic' ? 'rgba(200, 200, 200, 0.5)' :
       $rarity === 'rare' ? 'rgba(160, 160, 160, 0.5)' :
  ...
  &:hover {
    ...
    border-color: ${({ $rarity, $unlocked }) => 
      $unlocked ? 
        ($rarity === 'legendary' ? 'rgba(255, 255, 255, 0.8)' :
         $rarity === 'epic' ? 'rgba(200, 200, 200, 0.7)' :
         $rarity === 'rare' ? 'rgba(160, 160, 160, 0.7)' :
  ...
  &::before {
    ...
    background: ${({ $rarity, $unlocked }) => 
      $unlocked ? 
        ($rarity === 'legendary' ? 'linear-gradient(90deg, #ffffff, #f0f0f0)' :
         $rarity === 'epic' ? 'linear-gradient(90deg, #c8c8c8, #b0b0b0)' :
         $rarity === 'rare' ? 'linear-gradient(90deg, #a0a0a0, #909090)' :
         'linear-gradient(90deg, #808080, #707070)') :
      'linear-gradient(90deg, #606060, #505050)'};
  }
`;
...
const RewardIcon = styled.div<{ $icon?: string; $rarity: string }>`
  ...
  background: ${({ $icon, $rarity }) => 
    $icon ? `url(${$icon})` :
    $rarity === 'legendary' ? 'linear-gradient(135deg, #ffffff, #f0f0f0)' :
    $rarity === 'epic' ? 'linear-gradient(135deg, #c8c8c8, #b0b0b0)' :
    $rarity === 'rare' ? 'linear-gradient(135deg, #a0a0a0, #909090)' :
    'linear-gradient(135deg, #808080, #707070)'};
...
const ActionButton = styled.button<{ $variant?: 'primary' | 'secondary' | 'success' | 'danger' }>`
  background: ${({ $variant }) => 
    $variant === 'danger' ? 'linear-gradient(135deg, #666666, #555555)' :
    $variant === 'success' ? 'linear-gradient(135deg, #888888, #aaaaaa)' :
    $variant === 'secondary' ? 'rgba(255, 255, 255, 0.1)' :
    'linear-gradient(135deg, #777777, #999999)'};
  color: #ffffff;
  border: 1px solid ${({ $variant }) => 
    $variant === 'danger' ? '#555555' :
    $variant === 'success' ? '#aaaaaa' :
    $variant === 'secondary' ? 'rgba(255, 255, 255, 0.2)' :
    '#999999'};
  padding: 8px 16px;
  border-radius: 6px;
  font-size: 12px;
  ...
  &:hover {
    ...
    background: ${({ $variant }) => 
      $variant === 'danger' ? 'linear-gradient(135deg, #777777, #666666)' :
      $variant === 'success' ? 'linear-gradient(135deg, #999999, #bbbbbb)' :
      $variant === 'secondary' ? 'rgba(255, 255, 255, 0.15)' :
      'linear-gradient(135deg, #888888, #aaaaaa)'};
  }
