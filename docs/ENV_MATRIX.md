...
- `API_BASE_URL=https://wayesports.space`
- `WEBAPP_URL=https://wayesports.space`
- `BOT_USE_WEBHOOK=true|false`
- `BOT_WEBHOOK_PUBLIC_URL=https://wayesports.space` (required when webhook=true)
...
## Fast Verification
```bash
curl -i https://wayesports.space/api/health
curl -i https://wayesports.space/api/intelligence/readiness
curl -i https://wayesports.space/telegram/health
```
